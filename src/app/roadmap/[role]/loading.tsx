export default function Loading() {
  return (
    <div className="flex h-[calc(100vh-var(--navbar-height))] flex-col lg:flex-row animate-pulse">
      <aside className="hidden w-52 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 p-5 lg:block">
        <div className="h-3 w-20 rounded bg-gray-200 dark:bg-gray-800 mb-6" />
        <div className="space-y-6">
          {['a', 'b', 'c'].map((phase) => (
            <div key={phase}>
              <div className="h-2.5 w-16 rounded bg-gray-200 dark:bg-gray-800 mb-3" />
