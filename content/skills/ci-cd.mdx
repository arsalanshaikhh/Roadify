...
resources:
  ...
  - title: Continuous Delivery Foundation — Free Training
    ...
    type: course
    free: true
  - title: GitHub Actions — The Complete Guide – Udemy
    url: https://www.udemy.com/course/github-actions-the-complete-guide/
    type: course
    free: false
    rating: 4.7
  - title: "DevOps Projects: CI/CD with Jenkins, Docker & Kubernetes – Udemy"
    url: https://www.udemy.com/course/valaxy-devops/
    type: course
    free: false
    rating: 4.5
---
