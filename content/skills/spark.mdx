...
resources:
  ...
  - title: Apache Spark Official Getting Started
    ...
    type: docs
    free: true
  - title: Apache Spark with Python — PySpark – Udemy
    url: https://www.udemy.com/course/spark-and-python-for-big-data-with-pyspark/
    type: course
    free: false
    rating: 4.6
  - title: Databricks Certified Associate Developer – Udemy
    url: https://www.udemy.com/course/databricks-certified-associate-developer-for-apache-spark/
    type: course
    free: false
    rating: 4.5
---
